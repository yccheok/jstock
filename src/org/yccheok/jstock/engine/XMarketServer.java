 ...
 * @author yccheok
 */
public class XMarketServer implements MarketServer {

    private static final class XMarketBuilder implements Builder<XMarket> {
        private int up = 0;
        private int down = 0;
        ...
        public XMarketBuilder up(int up) {
            this.up = up;
            return this;
        }

        public XMarketBuilder down(int down) {
            this.down = down;
            return this;
        }

        public XMarketBuilder unchange(int unchange) {
            this.unchange = unchange;
            return this;
        }

        public XMarketBuilder volume(long volume) {
            this.volume = volume;
            return this;
        }

        public XMarketBuilder value(double value) {
            this.value = value;
            return this;
        }

        public XMarketBuilder index(Index index, double value) {
            this.index_value.put(index, value);
            return this;
        }

        public XMarketBuilder change(Index index, double change) {
            this.index_change.put(index, change);
            return this;
        }

        @Override
        public XMarket build() {
            return new XMarket(this);
        }

    }

    private static final class XMarket implements Market {
        ...
        public XMarket(XMarketBuilder builder) {
            this.up = builder.up;
    ...
    public Market getMarket() {
        ...
        final XMarketBuilder builder = new XMarketBuilder();
    ...
    private void initServers() {
        ...
        synchronized(servers_lock) {
            ...
            this.servers = Utils.getXMarketServers();
        }
    }
    ...
    private static final Log log = LogFactory.getLog(XMarketServer.class);
}
