 ...
 * @author yccheok
 */
public class SingaporeYahooStockHistoryServer implements StockHistoryServer {

    public SingaporeYahooStockHistoryServer(Country country, Code code) throws StockHistoryNotFoundException
    {
        this(country, code, DEFAULT_HISTORY_DURATION);
    }

    public SingaporeYahooStockHistoryServer(Country country, Code code, Duration duration) throws StockHistoryNotFoundException
    {
    ...
    private boolean parse(String respond)
    {
        ...
        SingaporeYahooStockServer singaporeYahooStockServer = new SingaporeYahooStockServer(country);
        try {
            Stock stock = singaporeYahooStockServer.getStock(code);
    ...
    // http://ichart.finance.yahoo.com/table.csv?s=JAVA&d=10&e=14&f=2008&g=d&a=2&b=11&c=1987&ignore=.csv
    // d = end month (0-11)
    // e = end date
    // f = end year
    // g = daily?
    ...
    private static final Log log = LogFactory.getLog(SingaporeYahooStockHistoryServer.class);
}
