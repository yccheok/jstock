 ...
 * @author yccheok
 */
public class YahooSweedenStockServerFactory implements StockServerFactory {

    private YahooSweedenStockServerFactory() {}
    
    public static StockServerFactory newInstance() {
        return new YahooSweedenStockServerFactory();
    }
