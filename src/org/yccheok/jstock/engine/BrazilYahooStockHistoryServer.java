 ...
 * @author yccheok
 */
public class BrazilYahooStockHistoryServer implements StockHistoryServer {

    public BrazilYahooStockHistoryServer(Country country, Code code) throws StockHistoryNotFoundException
    {
        this(country, code, DEFAULT_HISTORY_DURATION);
    }

    public BrazilYahooStockHistoryServer(Country country, Code code, Duration duration) throws StockHistoryNotFoundException
    {
    ...
    private boolean parse(String respond)
    {
        ...
        BrazilYahooStockServer brazilYahooStockServer = new BrazilYahooStockServer(country);
        try {
            Stock stock = brazilYahooStockServer.getStock(code);
    ...
    private static final Log log = LogFactory.getLog(BrazilYahooStockHistoryServer.class);
}
