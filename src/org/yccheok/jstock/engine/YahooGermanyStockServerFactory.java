 ...
 * @author yccheok
 */
public class YahooGermanyStockServerFactory implements StockServerFactory {

    private YahooGermanyStockServerFactory() {}
    
    public static StockServerFactory newInstance() {
        return new YahooGermanyStockServerFactory();
    }
