 ...
 * @author yccheok
 */
public class WizardIndicatorConstructionDescriptor extends WizardPanelDescriptor implements java.beans.PropertyChangeListener {
    
    public static final String IDENTIFIER = "INDICATOR_CONSTRUCTION_PANEL";
    
    private WizardIndicatorConstructionJPanel wizardIndicatorConstructionJPanel;
    
    /** Creates a new instance of WizardDownloadHistoryProgressDescriptor */
    public WizardIndicatorConstructionDescriptor() {
        super(IDENTIFIER, new WizardIndicatorConstructionJPanel());
        
        wizardIndicatorConstructionJPanel = (WizardIndicatorConstructionJPanel)getPanelComponent();
        wizardIndicatorConstructionJPanel.addMyPropertyChangeListener(this);
    }
    ...
    public Object getBackPanelDescriptor() {
        return WizardSelectHistoryDescriptor.IDENTIFIER;
    }
    ...
    public void aboutToHidePanel() {
        wizardIndicatorConstructionJPanel.stopConstructing();
    }    
}
