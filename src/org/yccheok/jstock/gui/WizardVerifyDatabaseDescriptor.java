 ...
 * @author yccheok
 */
public class WizardVerifyDatabaseDescriptor extends WizardPanelDescriptor implements java.beans.PropertyChangeListener {
    
    public static final String IDENTIFIER = "VERIFY_HISTORY_PANEL";
    
    private WizardVerifyDatabaseJPanel wizardVerifyHistoryProgressJPanel;
    
    /** Creates a new instance of WizardDownloadHistoryProgressDescriptor */
    public WizardVerifyDatabaseDescriptor() {
        super(IDENTIFIER, new WizardVerifyDatabaseJPanel());
        
        wizardVerifyHistoryProgressJPanel = (WizardVerifyDatabaseJPanel)getPanelComponent();
        wizardVerifyHistoryProgressJPanel.addMyPropertyChangeListener(this);
    }
    ...
    public void aboutToHidePanel() {
        wizardVerifyHistoryProgressJPanel.stopVerify();
    }    
}
