...
public class MutableStockBeanInfo extends SimpleBeanInfo {
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_secondBuyPrice] = new PropertyDescriptor ( "secondBuyPrice", org.yccheok.jstock.gui.MutableStock.class, "getSecondBuyPrice", "setSecondBuyPrice" ); // NOI18N
            properties[PROPERTY_secondBuyQuantity] = new PropertyDescriptor ( "secondBuyQuantity", org.yccheok.jstock.gui.MutableStock.class, "getSecondBuyQuantity", "setSecondBuyQuantity" ); // NOI18N
            properties[PROPERTY_secondSellPrice] = new PropertyDescriptor ( "secondSellPrice", org.yccheok.jstock.gui.MutableStock.class, "getSecondSellPrice", "setSecondSellPrice" ); // NOI18N
            properties[PROPERTY_secondSellQuantity] = new PropertyDescriptor ( "secondSellQuantity", org.yccheok.jstock.gui.MutableStock.class, "getSecondSellQuantity", "setSecondSellQuantity" ); // NOI18N
            ...
            properties[PROPERTY_thirdBuyPrice] = new PropertyDescriptor ( "thirdBuyPrice", org.yccheok.jstock.gui.MutableStock.class, "getThirdBuyPrice", "setThirdBuyPrice" ); // NOI18N
            properties[PROPERTY_thirdBuyQuantity] = new PropertyDescriptor ( "thirdBuyQuantity", org.yccheok.jstock.gui.MutableStock.class, "getThirdBuyQuantity", "setThirdBuyQuantity" ); // NOI18N
            properties[PROPERTY_thirdSellPrice] = new PropertyDescriptor ( "thirdSellPrice", org.yccheok.jstock.gui.MutableStock.class, "getThirdSellPrice", "setThirdSellPrice" ); // NOI18N
            properties[PROPERTY_thirdSellQuantity] = new PropertyDescriptor ( "thirdSellQuantity", org.yccheok.jstock.gui.MutableStock.class, "getThirdSellQuantity", "setThirdSellQuantity" ); // NOI18N
