...
public class IndicatorDownloadManager {
    ...
    public static void deploy() {
        try {
            ...
            org.yccheok.jstock.gui.Utils.toXML(me, "C:\\Projects\\jstock-static\\war\\alert_indicators\\indicator_download_manager.xml");
        ...
        try {
            ...
            org.yccheok.jstock.gui.Utils.toXML(me, "C:\\Projects\\jstock-static\\war\\alert_indicators\\zh\\indicator_download_manager.xml");
        } catch (MalformedURLException ex) {
            Logger.getLogger(IndicatorDownloadManager.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
